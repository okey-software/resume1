...
('LOGS', 'Модуль аудита','Обеспечивает работу аудита и всех остальных модулей'),
...
('LOCALITIES', 'Модуль перевода','Помощь автоматического или ручного перевода текста, создания и хранения локализованных версий контента'),
('MESSAGES', 'Модуль  для работы с сообщениями','Отвечает за реализацию функциональности сообщений в системе.'),
('PAYS', 'Модуль микросервиса для работы с платежами и тразакциями','Обеспечивает возможность оплаты в системе, интеграция с  платежными системами, такими как Visa, Mastercard, PayPal'),
('REFFERALS', 'Модуль для работы с реферальными программами',' Обеспечивает реализацию реферальной программы в системе.'),
...
('STORE', 'Модуль для работы с магазином устройств','Отвечает за реализацию функциональности интернет магазина в системе'),
('SUPPORT', 'Модуль тех поддержки клиентов', 'Отвечает за реализацию функциональности системы технической поддержки в системе, может обрабатывать информацию о запросах поддержки, обращениях и тикетах.'),
